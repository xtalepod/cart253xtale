...
{x:	55	, y:	270	, width:	5	, height:	420	},
{x:	85	, y:	475	, width:	70	, height:	5	},
{x:	125	, y:	425	, width:	5	, height:	110	},
{x:	125	, y:	270	, width:	5	, height:	120	},
{x:	90	, y:	215	, width:	60	, height:	5	},
{x:	115	, y:	165	, width:	110	, height:	5	},
{x:	115	, y:	115	, width:	110	, height:	5	},
{x:	215	, y:	130	, width:	5	, height:	40	},
{x:	235	, y:	115	, width:	50	, height:	5	},
{x:	265	, y:	170	, width:	5	, height:	100	},
{x:	210	, y:	215	, width:	100	, height:	5	},
{x:	165	, y:	275	, width:	5	, height:	110	},
{x:	220	, y:	325	, width:	100	, height:	5	},
{x:	265	, y:	295	, width:	5	, height:	50	},
{x:	240	, y:	265	, width:	60	, height:	5	},
{x:	315	, y:	95	, width:	5	, height:	50	},
{x:	395	, y:	115	, width:	150	, height:	5	},
{x:	465	, y:	170	, width:	5	, height:	100	},
{x:	485	, y:	215	, width:	30	, height:	5	},
{x:	375	, y:	165	, width:	90	, height:	5	},
{x:	415	, y:	195	, width:	5	, height:	50	},
...
// {x:	355	, y:	125	, width:	70	, height:	10	}
    ...
    for (let i = 0; i < this.wallProperties.length; i++) {
      ...
      // let wallText= new TestWall(this.windowWidth/2 + this.wallProperties[i].x-30,this.wallProperties[i].y, this.wallProperties[i].width, this.wallProperties[i].height);
